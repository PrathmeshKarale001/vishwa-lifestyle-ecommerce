        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            ...
            <div className="flex items-center flex-wrap gap-4 mb-6">
              ...
              <div
                className="flex items-center text-accent-gold text-sm"
              ...
              <div className="mb-6 p-4 bg-accent-gold/5 border border-accent-gold/20 rounded-lg">
                ...
                <div className="space-y-2">
                  {activeCoupons.map((coupon, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between text-sm bg-white p-2 rounded border border-dashed border-gray-300"
                    >
                      <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {product.variants.map((v: ProductVariant) => (
                    <button
                      ...
                      className={`min-w-[48px] h-12 px-4 border text-sm transition-all duration-300 ${
            ...
            <div className="flex flex-col space-y-4 mb-8">
              <div className="flex items-center gap-3 sm:gap-6">
                ...
                >
                  ...
                  <span
                    className="w-8 sm:w-12 text-center text-xs sm:text-sm"
                  ...
                  <button
                    onClick={() =>
                      setQuantity(
                        Math.min(currentInventory || 10, quantity + 1),
                      )
                    }
                    className="p-2 sm:p-3 hover:bg-gray-50 transition-colors"
                    aria-label="Increase quantity"
                    disabled={
                      isOutOfStock || quantity >= (currentInventory || 10)
                    }
                  >
                ...
                <button
                  ...
                  disabled={isOutOfStock}
                  className={`flex-1 py-3 sm:py-4 px-4 sm:px-6 uppercase tracking-[0.1em] sm:tracking-widest text-[10px] sm:text-sm transition-colors duration-300 flex items-center justify-center gap-2 ${
                    isOutOfStock
            ...
            <div className="grid grid-cols-3 gap-4 py-6 border-t border-b border-gray-100 mb-8">
              <div className="text-center">
                <Truck
                  size={20}
                  className="mx-auto mb-2 text-accent-gold"
                  aria-hidden="true"
                />
            ...
            {product.features && product.features.length > 0 && (
              <div className="mb-8">
                <h2 className="font-serif text-lg mb-4 text-foreground/90">
                  What's Included
                </h2>
        ...
        <section className="py-20 container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {relatedProducts.map((relatedProduct: Product) => {
              const tag = relatedProduct.isBestSeller
                ? "Best Seller"
