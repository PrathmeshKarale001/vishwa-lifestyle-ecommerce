export const metadata = {
  ...
  description:
    "Vishwa Lifestyle Privacy Policy - How we collect, use, and protect your information.",
};
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-foreground-muted mb-4">
                At Vishwa Lifestyle, we collect information to provide better
                services to our customers. We collect information in the
                following ways:
              </p>
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-muted mb-4">
                We work with trusted third parties who may have access to your
                data:
              </p>
              <ul className="list-disc pl-6 text-foreground-muted space-y-2">
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-muted mt-4">
                ...
                <br />
                <strong>Address:</strong> Shivpuri, Akkalkot Station Road,
                Akkalkot 413216
              </p>
            </section>
          </div>
