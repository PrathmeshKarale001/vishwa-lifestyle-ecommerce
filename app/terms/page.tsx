export const metadata = {
  ...
  description:
    "Vishwa Lifestyle Terms of Service - Rules and guidelines for using our platform.",
};
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-foreground-muted">
                By accessing and using Vishwa Lifestyle ("the Website"), you
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-foreground-muted space-y-2">
                ...
                <li>
                  We accept payments via Razorpay (UPI, Cards, Net Banking,
                  Wallets)
                </li>
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-muted">
                ...
                designs, is the property of Vishwa Lifestyle and protected by
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-muted">
                Vishwa Lifestyle shall not be liable for any indirect,
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-muted">
                ...
                shall be resolved in the courts of Maharashtra, India.
              </p>
            </section>
